 ...
 */
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    { field: 'country', rowGroup: true, hide: true,cellRenderer: countryCellRenderer },
    ...
    {field: 'date'},
    {field: 'sport'},
    {field: 'gold', type: 'number', aggFunc: 'sum'}, //, checkboxSelection:true
    {field: 'silver', type: 'number', aggFunc: 'sum' },         /** , aggFunc: 'sum' AJOUTE POUR LE SUBTOTAL */
    {field: 'bronze', type: 'number', aggFunc: 'sum' },      //, type: 'numberValue' 
...
const onFirstDataRendered = useCallback((params) => {
  ...
  return (
    <div className="App-box">
        ...
        <h1 className='titleP'>PRESENTATION 9</h1>
        <span>ROW GROUPING - CUSTOM GROUP COLUMNS - SUBTOTAL ROWS WITH GRAND TOTAL</span>


        {/* On div wrapping Grid a) specify theme CSS Class Class and b) sets Grid size */}
        <div className="ag-theme-alpine" style={{width: '95vw', height: 500}} id="">
